...
class_database = {
    ...
    "JACOB COOPER": Data("student", 2, 5, 7),
    "CHANTREL DAULTON": Data("student", 4, 5, 6),
    "ROY ESEYAN": Data("student", 3, 5, 4),
    ...
    "SKYE OWENS": Data("student", 2, 5, 7),
    "CAMDEN PHAM": Data("student", 5, 2, 7),
    "LUISA ROSA SILVA": Data("student", 7, 5, 6),
    ...
    "DARREN VAN ORDT": Data("student", 4, 5, 9),
